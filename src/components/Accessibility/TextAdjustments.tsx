...
export default function TextAdjustments({ settings, onToggle }: TextAdjustmentsProps) {
  const textOptions = [
    {
      key: 'readableFont',
      label: 'Readable Font',
      icon: <FontDownload sx={{ fontSize: 20 }} />,
      description: 'Use accessible font family'
    },
    {
      key: 'highlightTitles',
      label: 'Highlight Titles',
      icon: <Title sx={{ fontSize: 20 }} />,
      description: 'Emphasize headings'
    },
    {
      key: 'highlightLinks',
      label: 'Highlight Links',
      icon: <Link sx={{ fontSize: 20 }} />,
      description: 'Outline clickable links'
    },
    {
      key: 'textMagnifier',
      label: 'Text Magnifier',
      icon: <ZoomIn sx={{ fontSize: 20 }} />,
      description: 'Enlarge text content'
    }
  ];
